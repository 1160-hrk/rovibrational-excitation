...
from rovibrational_excitation.dipole.vib.morse import tdm_vib_morse, omega01_domega_to_N
...
class TestVibLadderDipoleMatrix:
    ...
    def test_morse_z_component(self):
        """Morse振動子z成分のテスト"""
        basis = VibLadderBasis(V_max=2, omega_rad_phz=1.0, delta_omega_rad_phz=0.1)
