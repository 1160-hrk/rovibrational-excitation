...
class TestLinMolDipoleMatrix:
    ...
    def test_numpy_vs_cupy_consistency(self):
        ...
        if HAS_CUPY:
            ...
            np.testing.assert_array_almost_equal(mu_np, cp_local.asnumpy(mu_cp), decimal=10)
...
class TestBuildMuFunction:
    ...
    def test_build_mu_invalid_potential(self):
        ...
        with pytest.raises(ValueError, match="potential_type must be harmonic or morse"):
            # 型チェッカー回避のためキャスト
